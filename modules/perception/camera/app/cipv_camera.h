...
class Cipv {
 ...
 private:
  ...
  bool FindClosestEdgeOfObjectImage(const std::shared_ptr<base::Object> &object,
  ...
  bool image2ground(const float image_x, const float image_y,
    float *ground_x, float *ground_y);
  bool ground2image(const float ground_x, const float ground_y,
